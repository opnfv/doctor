...
perform recovery actions promptly to shorten down time of my service.
...
* New alarm evaluator could be receive event notification from Notification
  Agent  by which adding a dedicated notifier as a publisher in pipeline.yaml
