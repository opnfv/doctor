...
get_compute_host_info() {
    ...
    openstack --debug $as_admin_user --os-identity-api-version 2 server show ${VM_BASENAME}1
    COMPUTE_HOST=$(openstack --debug $as_admin_user --os-identity-api-version 2 server show ${VM_BASENAME}1 |
