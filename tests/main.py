...
class DoctorTest(object):
    ...
    def __init__(self, conf):
        ...
        self._init_os_clients(self.session)
    ...
    def _init_os_clients(self):
        self.os_clients =  {
            ...
            "ceilometer": os_clients.ceilometer_client(self.conf, self.session),
    ...
    def upload_image_to_cloud(self):
        ...
        images = {image.name: image for image in nova_client.images.list()}
