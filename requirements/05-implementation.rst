...
by Zabbix. The Controller is realized by OpenStack Nova [5], Neutron [6]_, and
Cinder [7]_ for compute, network, and storage, respectively. The Inspector can
be realized by Monasca [8]_ or a simple script querying Nova in order to map
between physical and virtual resources. The Notifier will be realized by
Ceilometer [4]_ receiving failure events on its notification bus.
