...
from doctor_tests.common.utils import run_async
        ...
        if isinstance(script_names, list):
            for script_name in script_names:
                ...
                if self.use_containers:
                    # Apex only have python2 in Queens
                    # Apex also had required PyYAML missing from python3 in
                    # Pike
            ...
            if 'nova-scheduler' in restart_cmd:
                #Let's make sure scheduler has proper cpu_allocation_ratio
                time.sleep(5)
